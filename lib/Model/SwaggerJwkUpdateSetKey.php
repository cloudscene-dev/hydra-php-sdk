 ...
 * @link     https://openapi-generator.tech
 */
class SwaggerJwkUpdateSetKey implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'swaggerJwkUpdateSetKey';
    ...
    protected static $openAPITypes = [
        'body' => '\OpenAPI\Client\Model\JSONWebKey',
        'kid' => 'string',
        'set' => 'string'
    ];
     ...
     * Sets body
     *
     * @param \OpenAPI\Client\Model\JSONWebKey|null $body body
     *
     * @return $this
     */
