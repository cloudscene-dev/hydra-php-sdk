 ...
 * @link     https://openapi-generator.tech
 */
class HandledLoginRequest implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'HandledLoginRequest';
     ...
     * Sets remember_for
     *
     * @param int|null $remember_for RememberFor sets how long the authentication should be remembered for in seconds. If set to `0`, the authorization will be remembered indefinitely.
     *
     * @return $this
     */
