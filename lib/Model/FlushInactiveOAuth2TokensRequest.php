...
class FlushInactiveOAuth2TokensRequest implements ModelInterface, ArrayAccess
{
     ...
     * Sets not_after
     *
     * @param \DateTime|null $not_after NotAfter sets after which point tokens should not be flushed. This is useful when you want to keep a history of recently issued tokens for auditing.
     *
     * @return $this
     */
