...
class GenericError implements ModelInterface, ArrayAccess
{
     ...
     * Sets error_code
     *
     * @param int|null $error_code Code represents the error status code (404, 403, 401, ...).
     *
     * @return $this
     */
     ...
     * Sets error_debug
     *
     * @param string|null $error_debug Debug contains debug information. This is usually not available and has to be enabled.
     *
     * @return $this
     */
     ...
     * Sets error_hint
     *
     * @param string|null $error_hint Hint contains further information on the nature of the error.
     *
     * @return $this
     */
