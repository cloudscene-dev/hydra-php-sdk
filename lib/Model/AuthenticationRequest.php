...
class AuthenticationRequest implements ModelInterface, ArrayAccess
{
    ...
    protected static $openAPITypes = [
        'challenge' => 'string',
        'client' => '\OpenAPI\Client\Model\Client',
     ...
     * Sets challenge
     *
     * @param string|null $challenge Challenge is the identifier (\"authentication challenge\") of the consent authentication request. It is used to identify the session.
     *
     * @return $this
     */
     ...
     * Gets client
     *
     * @return \OpenAPI\Client\Model\Client|null
     */
     ...
     * Sets client
     *
     * @param \OpenAPI\Client\Model\Client|null $client client
     *
     * @return $this
     */
     ...
     *
     * @param string[]|null $requested_access_token_audience RequestedScope contains the access token audience as requested by the OAuth 2.0 Client.
     *
     * @return $this
     */
     ...
     *
     * @param string[]|null $requested_scope RequestedScope contains the OAuth 2.0 Scope requested by the OAuth 2.0 Client.
     *
     * @return $this
     */
     ...
     * Sets session_id
     *
     * @param string|null $session_id SessionID is the authentication session ID. It is set if the browser had a valid authentication session at ORY Hydra during the login flow. It can be used to associate consecutive login requests by a certain user.
     *
     * @return $this
     */
