...
class Client implements ModelInterface, ArrayAccess
{
    ...
    protected static $openAPITypes = [
        ...
        'created_at' => '\DateTime',
        'grant_types' => 'string[]',
        'jwks' => '\OpenAPI\Client\Model\SwaggerJSONWebKeySet',
        'jwks_uri' => 'string',
        'logo_uri' => 'string',
        'owner' => 'string',
        'policy_uri' => 'string',
     ...
     *
     * @param string[]|null $allowed_cors_origins AllowedCORSOrigins are one or more URLs (scheme://host[:port]) which are allowed to make CORS requests to the /oauth/token endpoint. If this array is empty, the sever's CORS origin configuration (`CORS_ALLOWED_ORIGINS`) will be used instead. If this array is set, the allowed origins are appended to the server's CORS origin configuration. Be aware that environment variable `CORS_ENABLED` MUST be set to `true` for this to work.
     *
     * @return $this
     */
     ...
     * Sets client_id
     *
     * @param string|null $client_id ClientID  is the id for this client.
     *
     * @return $this
     */
     ...
     * Sets created_at
     *
     * @param \DateTime|null $created_at CreatedAt returns the timestamp of the client's creation. Format: date-time Format: date-time Format: date-time Format: date-time Format: date-time Format: date-time Format: date-time Format: date-time Format: date-time Format: date-time Format: date-time
     *
     * @return $this
     */
     ...
     * Sets grant_types
     *
     * @param string[]|null $grant_types GrantTypes is an array of grant types the client is allowed to use.
     *
     * @return $this
     */
     ...
     * Gets jwks
     *
     * @return \OpenAPI\Client\Model\SwaggerJSONWebKeySet|null
     */
     ...
     * Sets jwks
     *
     * @param \OpenAPI\Client\Model\SwaggerJSONWebKeySet|null $jwks jwks
     *
     * @return $this
     */
     ...
     * Sets redirect_uris
     *
     * @param string[]|null $redirect_uris RedirectURIs is an array of allowed redirect urls for the client, for example http://mydomain/oauth/callback .
     *
     * @return $this
     */
     ...
     * Sets request_uris
     *
     * @param string[]|null $request_uris Array of request_uri values that are pre-registered by the RP for use at the OP. Servers MAY cache the contents of the files referenced by these URIs and not retrieve them at the time they are used in a request. OPs can require that request_uri values used be pre-registered with the require_request_uri_registration discovery parameter.
     *
     * @return $this
     */
     ...
     * Sets response_types
     *
     * @param string[]|null $response_types ResponseTypes is an array of the OAuth 2.0 response type strings that the client can use at the authorization endpoint.
     *
     * @return $this
     */
    ...
    public function setScope($scope)
    {
        ...
        if (!is_null($scope) && (!preg_match("/([a-zA-Z0-9\\.\\*]+\\s?)+/", $scope))) {
            throw new \InvalidArgumentException("invalid value for $scope when calling Client., must conform to the pattern /([a-zA-Z0-9\\.\\*]+\\s?)+/.");
        }
     ...
     * Sets updated_at
     *
     * @param \DateTime|null $updated_at UpdatedAt returns the timestamp of the last update. Format: date-time Format: date-time Format: date-time Format: date-time Format: date-time Format: date-time Format: date-time Format: date-time Format: date-time Format: date-time Format: date-time
     *
     * @return $this
     */
