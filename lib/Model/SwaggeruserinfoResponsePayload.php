 ...
 *
 * @category Class
 * @description SwaggeruserinfoResponsePayload The userinfo response
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 */
class SwaggeruserinfoResponsePayload implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'swaggeruserinfoResponsePayload';
