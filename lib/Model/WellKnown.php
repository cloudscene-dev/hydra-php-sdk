...
class WellKnown implements ModelInterface, ArrayAccess
{
     ...
     *
     * @param bool|null $backchannel_logout_session_supported Boolean value specifying whether the OP can pass a sid (session ID) Claim in the Logout Token to identify the RP session with the OP. If supported, the sid Claim is also included in ID Tokens issued by the OP
     *
     * @return $this
     */
     ...
     *
     * @param bool|null $backchannel_logout_supported Boolean value specifying whether the OP supports back-channel logout, with true indicating support.
     *
     * @return $this
     */
     ...
     *
     * @param bool|null $claims_parameter_supported Boolean value specifying whether the OP supports use of the claims parameter, with true indicating support.
     *
     * @return $this
     */
     ...
     *
     * @param string[]|null $claims_supported JSON array containing a list of the Claim Names of the Claims that the OpenID Provider MAY be able to supply values for. Note that for privacy or other reasons, this might not be an exhaustive list.
     *
     * @return $this
     */
     ...
     *
     * @param string|null $end_session_endpoint URL at the OP to which an RP can perform a redirect to request that the End-User be logged out at the OP.
     *
     * @return $this
     */
     ...
     *
     * @param bool|null $frontchannel_logout_supported Boolean value specifying whether the OP supports HTTP-based logout, with true indicating support.
     *
     * @return $this
     */
     ...
     *
     * @param string[]|null $grant_types_supported JSON array containing a list of the OAuth 2.0 Grant Type values that this OP supports.
     *
     * @return $this
     */
     ...
     *
     * @param string|null $registration_endpoint URL of the OP's Dynamic Client Registration Endpoint.
     *
     * @return $this
     */
     ...
     *
     * @param bool|null $request_parameter_supported Boolean value specifying whether the OP supports use of the request parameter, with true indicating support.
     *
     * @return $this
     */
     ...
     *
     * @param bool|null $request_uri_parameter_supported Boolean value specifying whether the OP supports use of the request_uri parameter, with true indicating support.
     *
     * @return $this
     */
     ...
     *
     * @param bool|null $require_request_uri_registration Boolean value specifying whether the OP requires any request_uri values used to be pre-registered using the request_uris registration parameter.
     *
     * @return $this
     */
     ...
     *
     * @param string[]|null $response_modes_supported JSON array containing a list of the OAuth 2.0 response_mode values that this OP supports.
     *
     * @return $this
     */
     ...
     *
     * @param string|null $revocation_endpoint URL of the authorization server's OAuth 2.0 revocation endpoint.
     *
     * @return $this
     */
     ...
     *
     * @param string[]|null $scopes_supported SON array containing a list of the OAuth 2.0 [RFC6749] scope values that this server supports. The server MUST support the openid scope value. Servers MAY choose not to advertise some supported scope values even when this parameter is used
     *
     * @return $this
     */
     ...
     *
     * @param string[]|null $token_endpoint_auth_methods_supported JSON array containing a list of Client Authentication methods supported by this Token Endpoint. The options are client_secret_post, client_secret_basic, client_secret_jwt, and private_key_jwt, as described in Section 9 of OpenID Connect Core 1.0
     *
     * @return $this
     */
     ...
     *
     * @param string|null $userinfo_endpoint URL of the OP's UserInfo Endpoint.
     *
     * @return $this
     */
     ...
     *
     * @param string[]|null $userinfo_signing_alg_values_supported JSON array containing a list of the JWS [JWS] signing algorithms (alg values) [JWA] supported by the UserInfo Endpoint to encode the Claims in a JWT [JWT].
     *
     * @return $this
     */
