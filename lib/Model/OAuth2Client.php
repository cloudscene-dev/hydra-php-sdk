...
class OAuth2Client implements ModelInterface, ArrayAccess
{
     ...
     * Gets jwks
     *
     * @return \OpenAPI\Client\Model\JSONWebKeySet|null
     */
     ...
     * Sets jwks
     *
     * @param \OpenAPI\Client\Model\JSONWebKeySet|null $jwks jwks
     *
     * @return $this
     */
     ...
     *
     * @param string[]|null $post_logout_redirect_uris Array of URLs supplied by the RP to which it MAY request that the End-User's User Agent be redirected using the post_logout_redirect_uri parameter after a logout has been performed.
     *
     * @return $this
     */
